 ...
 * @param {string} type - The name of the icon to display.
 * @param {function} action - A function to be called when the icon is clicked.
 * @returns {JSX.Element} - The JSX element representing the icon.
 */
export default function Icon({ type, action = () => {} }) {
  switch (type) {
    case "close":
      return (
        <span className="icon clickable" onClick={action}>
